...
namespace ReservaVuelos.Application.Common.Struct
{
	public struct ConfigurationStruct
	{
		...
		public const string Contact = "https://www.aviatur.com/";
		...
		public const string RESERVAS_DB_CONEXION = "RESERVAS_DB_CONEXION";
		#endregion


		#region[NOMBRES ENDPOINTS]
		public const string AVIATIONSTACK = "AVIATIONSTACK";
		#endregion
