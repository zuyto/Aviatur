...
//using ReservaVuelos.Application.Common.Enumerations;
...
//    public class BifurcacionDatosPromiseEngine(ISerilogImplements serilogImplements, IUnitOfWorkHcInvSgl unitOfWorkHcInvSgl) : IBifurcacionDatosPromiseEngine
//    {

//        private readonly ISerilogImplements _serilogImplements = serilogImplements;
//        private readonly IUnitOfWorkHcInvSgl _unitOfWorkHcInvSgl = unitOfWorkHcInvSgl;
...
//        /// <returns></returns>
//        public async Task<List<DtoProductoConCobertura>> BifurcacionDatosProdCobert(DtoJsonRequest rqs)
//        {
